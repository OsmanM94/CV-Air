    ...
    var body: some View {
        ZStack {
            ...
            VStack(alignment: .leading, spacing: 10) {
                ...
                Text("")
                Text("Our app ensures your CV is ATS-compliant, so it won't be missed by potential employers. Simple, effective, and right on their desk—just the way it should be!")
